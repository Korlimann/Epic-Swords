...
public class EntityTerraBladeBeam extends EntityFireball implements IHasModel{
	...
	public EntityTerraBladeBeam(World worldIn) {
		super(worldIn);
    ...
    public EntityTerraBladeBeam(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityTerraBladeBeam(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
        super(worldIn);
