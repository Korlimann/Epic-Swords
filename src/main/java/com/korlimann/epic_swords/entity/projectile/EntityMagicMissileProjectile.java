...
public class EntityMagicMissileProjectile extends EntityFireball {
	...
	public EntityMagicMissileProjectile(World worldIn) {
		super(worldIn);
	}
	
	public EntityMagicMissileProjectile(World worldIn, double x, double y, double z, double accelX, double accelY, double accelZ) {
	...
	public EntityMagicMissileProjectile(World worldIn, EntityLivingBase shooter, double accelX, double accelY, double accelZ) {
