...
public class EntityMagicMissileProjectile extends EntityThrowable {
	...
	public EntityMagicMissileProjectile(World worldIn, EntityLivingBase thrower) {
		super(worldIn, thrower);
		this.thrower = thrower;
		this.setDamage(5);
	}

	public EntityMagicMissileProjectile(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
		this.setDamage(5);
	}
